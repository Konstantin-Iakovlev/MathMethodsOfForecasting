...
def rmse(y_true, y_pred):
    ...
    Parameters:
        y_true - true target variable of shape [objects, ...]
        y_pred - predicted variable of shape [objects, ...]
    """
...
class HOPLS:
    ...
    def score(self, X, Y):
        ...
        return self.metric(Y.reshape(Y.shape[0], -1), Y_pred[0].reshape(Y.shape[0], -1))
